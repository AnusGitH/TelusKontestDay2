...
public class Main {
  public static void main(String[] args) {
       ...
       service.addProduct(new Product("BlackBeast", "Computer", "White Table", 2020));
 		...
 		System.out.println("\n \n \n The products at the place Black Table: ");

		   List<Product> prdctfplc = service.getProductOfPlace("Black Table");
		   for(Product product : prdctfplc){
		       System.out.println(product);
		   }
       
       System.out.println("\n \n \n Out of warranty products for the current year 2023");

       List<Product> prdctofwrnty = service.getProductOutOfWarranty();
       for(Product product : prdctofwrnty){
           System.out.println(product);
       }   
  }
  }
